...
* ```Peast::ES2026(source, options)``` or ```Peast::ES17(source, options)```: parse using EcmaScript 2026 (ES17) syntax
* ```Peast::ES2027(source, options)``` or ```Peast::ES18(source, options)```: parse using EcmaScript 2027 (ES18) syntax
