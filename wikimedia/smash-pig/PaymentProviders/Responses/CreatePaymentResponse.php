...
/**
 * Represents a newly-created payment. Used to differ from the PaymentProviderExtendedResponse
 ...
 */
class CreatePaymentResponse extends PaymentProviderExtendedResponse {
