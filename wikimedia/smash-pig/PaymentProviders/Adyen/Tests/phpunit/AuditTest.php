...
class AuditTest extends BaseSmashPigUnitTestCase {
	...
	public function testProcessSettlementDetailDonation() {
		...
		$expected = [
			...
			'modification_reference' => '5555593193155555',
			'payment_method' => 'cc',
	...
	public function testProcessDonationIdeal() {
		...
		$expected = [
			...
			'capture_id' => '1515876691955555',
			'modification_reference' => '1515876691955555',
	...
	public function testProcessDonationAch() {
		...
		$expected = [
			...
			'auth_id' => 'GDC9ZZ4L2MONEY42',
			'backend_processor_txn_id' => 'GDC9ZZ4L2MONEY42',
			'capture_id' => 'X99BANANA6S8TN25',
	...
	public function testProcessSettlementDetailRefund() {
		...
		$expected = [
			...
			'date' => 1455128736,
			'gross' => '1.00',
			'backend_processor_txn_id' => '4522268860022701',
	...
	public function testProcessSettlementDetailChargeback() {
		...
		$expected = [
			...
			'backend_processor_txn_id' => '4555568860022701',
	...
	public function testProcessPaymentsAccountingNyce() {
		...
		$expected = [
			...
			'auth_id' => 'DASD76ASD7ASD4AS',
			'capture_id' => 'ASDF5ASDF4QWER3A',
