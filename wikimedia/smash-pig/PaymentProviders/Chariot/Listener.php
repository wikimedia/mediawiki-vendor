...
class Listener implements IHttpActionHandler {
	...
	public function execute( Request $request, Response $response ) {
		...
		if ( $valid ) {
			Logger::info( 'Chariot signature is valid' );
			/*QueueWrapper::push( 'jobs-chariot', [
				'class' => 'SmashPig\PaymentProviders\Chariot\Job',
				'payload' => $requestValues
			] );*/
			Logger::info( 'Pushed new message to jobs-chariot: ' .
