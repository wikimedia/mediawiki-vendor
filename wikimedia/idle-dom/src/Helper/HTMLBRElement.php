...
trait HTMLBRElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLBRElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLBRElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLBRElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLBRElement $this
