...
trait HTMLDialogElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLDialogElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLDialogElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLDialogElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLDialogElement $this
