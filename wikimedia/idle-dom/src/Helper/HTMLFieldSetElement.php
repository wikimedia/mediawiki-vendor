...
trait HTMLFieldSetElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLFieldSetElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLFieldSetElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLFieldSetElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLFieldSetElement $this
