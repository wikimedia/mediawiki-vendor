...
trait HTMLAudioElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLAudioElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLAudioElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLAudioElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLAudioElement $this
