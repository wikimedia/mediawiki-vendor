...
trait HTMLTemplateElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLTemplateElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLTemplateElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLTemplateElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLTemplateElement $this
