...
trait HTMLQuoteElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLQuoteElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLQuoteElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLQuoteElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLQuoteElement $this
