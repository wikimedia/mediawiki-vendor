...
trait HTMLMeterElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLMeterElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLMeterElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLMeterElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLMeterElement $this
