...
trait HTMLDetailsElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLDetailsElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLDetailsElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLDetailsElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLDetailsElement $this
