...
trait HTMLFormElement {
	...
	public function __get( string $name ) {
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLFormElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLFormElement $this
