...
trait HTMLTitleElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLTitleElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLTitleElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLTitleElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLTitleElement $this
