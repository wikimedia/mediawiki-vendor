...
trait HTMLVideoElement {
	...
	public function __get( string $name ) {
		...
		switch ( $name ) {
			...
			case "playsInline":
				return $this->getPlaysInline();
			default:
				break;
		}
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLVideoElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLVideoElement $this
