...
trait HTMLProgressElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLProgressElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLProgressElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLProgressElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLProgressElement $this
