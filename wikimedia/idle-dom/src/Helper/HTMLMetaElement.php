...
trait HTMLMetaElement {
	...
	public function __get( string $name ) {
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLMetaElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLMetaElement $this
