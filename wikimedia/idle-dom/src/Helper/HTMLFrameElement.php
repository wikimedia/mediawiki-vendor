...
trait HTMLFrameElement {
	...
	public function __get( string $name ) {
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLFrameElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLFrameElement $this
