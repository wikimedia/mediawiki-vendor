...
trait HTMLSpanElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLSpanElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLSpanElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLSpanElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLSpanElement $this
