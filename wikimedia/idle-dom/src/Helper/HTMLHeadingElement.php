...
trait HTMLHeadingElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLHeadingElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLHeadingElement $this
		switch ( $name ) {
			case "nodeType":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLHeadingElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLHeadingElement $this
