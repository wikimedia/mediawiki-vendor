...
trait HTMLTableRowElement {
	...
	public function __get( string $name ) {
		'@phan-var \Wikimedia\IDLeDOM\HTMLTableRowElement $this';
		// @var \Wikimedia\IDLeDOM\HTMLTableRowElement $this
		switch ( $name ) {
			case "nodeType":
			...
			case "sectionRowIndex":
				return $this->getSectionRowIndex();
			case "cells":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLTableRowElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLTableRowElement $this
