	...
	public function __get( string $name ) {
		...
		switch ( $name ) {
			...
			case "code":
				return $this->getCode();
			case "declare":
				return $this->getDeclare();
			case "hspace":
				return $this->getHspace();
			case "standby":
				return $this->getStandby();
			case "vspace":
		...
		'@phan-var \Wikimedia\IDLeDOM\Helper\HTMLObjectElement $this';
		// @var \Wikimedia\IDLeDOM\Helper\HTMLObjectElement $this
